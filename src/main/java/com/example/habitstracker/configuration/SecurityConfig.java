    ...
    public SecurityFilterChain securityFilterChain(
    ...
    ) throws Exception {
        {
            ...
            httpSecurity
                    ...
                    .authorizeRequests()
                    .antMatchers(HttpMethod.POST, ApiConstants.Auth.LOGIN, ApiConstants.Auth.REGISTRATION).permitAll()
                    .antMatchers(HttpMethod.GET,
                            SwaggerConstants.UI_ANY,
                            SwaggerConstants.RESOURCES_ANY,
                            SwaggerConstants.UI_HTML,
                            SwaggerConstants.API_DOCS,
                            SwaggerConstants.WEB_JARS).permitAll()
